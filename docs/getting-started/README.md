...
```bash
go get -u github.com/antelman107/telegram-bot-api/v5
```
...
[bot-api-docs]: https://pkg.go.dev/github.com/antelman107/telegram-bot-api/v5?tab=doc#BotAPI
...
import (
	...
	tgbotapi "github.com/antelman107/telegram-bot-api/v5"
)
